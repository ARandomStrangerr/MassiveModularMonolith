...
// data stream page control page behaviour
let dataStreamPageControl = new (require("./script/DataStreamPageControl.js"))();

// connection manager section behaviour
let connectionManagerPageControl = new (require("./script/ConnectionManagerPageControl.js"))();
