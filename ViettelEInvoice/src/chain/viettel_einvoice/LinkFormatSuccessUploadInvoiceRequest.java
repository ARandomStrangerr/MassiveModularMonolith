...
public class LinkFormatSuccessUploadInvoiceRequest extends Link {
	...
	public boolean execute() {
		...
		body.addProperty("success", String.format("Thành công tải lên %d hoá đơn", chain.getProcessObject().get("body").getAsJsonObject().get("totalNumber").getAsInt()));
		chain.getProcessObject().add("body", body); // set up the new body
